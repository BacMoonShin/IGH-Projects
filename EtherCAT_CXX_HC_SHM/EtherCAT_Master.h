...
class EtherCAT_Master
{
  ...
  private:
    ...
    void EtherCAT_Master_Config_Slave(EtherCAT_Slave_Base * Slave, int Slave_Index);
    void EtherCAT_Master_Config_Slave_DC(EtherCAT_Slave_Base * Slave, int Slave_Index);
    void EtherCAT_Master_Config_Slave_SDO(EtherCAT_Slave_Base * Slave, int Slave_Index);
    ...
    void Check_Domain_State(ec_domain_t *Domain, ec_domain_state_t *Domain_State, int Slave_Index);
    void Check_Master_State(ec_master_t *Master, ec_master_state_t *Master_State);
    void Check_Slave_Config_States(ec_slave_config_t *Slave, ec_slave_config_state_t *Slave_State, int Slave_Index);
};
