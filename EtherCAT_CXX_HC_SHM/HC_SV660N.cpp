...
void HC_SV660N::Get_SDO_Config_Reg(){
    ...
    (ec_sdo_config_reg_t){MOTOR_RESOLUTION, (uint8_t*)&sdo_data.motor_resolution, 4, &data.abort_code};
    HC_SV660N_sdo_config_regs[1] =
    (ec_sdo_config_reg_t){AXIS_RESOLUTION, (uint8_t*)&sdo_data.axis_resolution, 4, &data.abort_code};
