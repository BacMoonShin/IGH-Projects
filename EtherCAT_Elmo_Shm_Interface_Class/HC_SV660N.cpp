    ...
    switch(TxPDO)
    {
        case 0x1B01:
            ...
            domain_data.TxPDO.actual_position =
                EC_READ_U32(domain_pd + domain_offset.TxPDO.actual_position);
            domain_data.TxPDO.actual_torque =
                EC_READ_S16(domain_pd + domain_offset.TxPDO.actual_torque);
            ...
            data.actual_torque = ((double)(domain_data.TxPDO.actual_torque) / (double)(0x1000)) * motor.rated_torque;
            break;
        default:
...
void HC_SV660N::Get_PDO_Entry_Reg() noexcept{
    ...
    switch (TxPDO)
    {
        case 0x1B01:
            ...
            HC_SV660N_domain_regs[++count] =
            (ec_pdo_entry_reg_t){alias, position, vendor_id, product_code, ACTUAL_TORQUE, &domain_offset.TxPDO.actual_torque, NULL};
            HC_SV660N_domain_regs[++count] =
