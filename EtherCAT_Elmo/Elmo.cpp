...
ec_pdo_entry_info_t ELMO::ELMO_pdo_entries[5] = {/*RxPDO 0x1607 */
                                                {TARGET_POSITION, 32},
                                                {CTRL_WORD, 16},
                                                /* TxPDO 0x1A07 */
                                                {CURRENT_POSITION, 32},
...
ec_pdo_info_t ELMO::ELMO_pdos[2] = {// RxPDO
...
void ELMO::Get_SDO_Config_Reg() noexcept{
    ...
    ELMO_sdo_config_regs[++count] =
    (ec_sdo_config_reg_t){OPERATION_MODE, (uint8_t*)&sdo_data.operation_mode_0x6060_0x00, 1, &data.abort_code};
    // ELMO_sdo_config_regs[++count] =
    // (ec_sdo_config_reg_t){MAX_CURRENT, (uint8_t*)&sdo_data.max_current_0x6073_0x00, 2, &data.abort_code};
    ELMO_sdo_config_regs[++count] =
