...
struct ELMO_SDO_Data{
    ...
    // uint16_t max_current_0x6073_0x00;
};
...
class ELMO : public EtherCAT_Slave_Base
{
  private:
    ...
    static ec_pdo_entry_info_t ELMO_pdo_entries[5];
    static ec_pdo_info_t ELMO_pdos[2];
    ec_pdo_entry_reg_t ELMO_domain_regs[6];
    ec_sdo_config_reg_t ELMO_sdo_config_regs[5];
