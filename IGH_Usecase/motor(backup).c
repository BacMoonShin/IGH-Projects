...
init_EtherCAT_master(struct MOTOR *motor)
{
    ...
    ec_pdo_entry_reg_t domain_regs[] = {
        /* {从站在总线上的位置，迈信伺服的厂家标识和产品标识，PDO数据对象在对象字典中对应的主索引，PDO数据对象在对象字典中的子索引，绑定到该对象字典索引的变量} */
...
int main(int argc, char **argv)
{
    ...
    while (true)
    {
        ...
        positionCommand = EC_READ_S32(
            motor.domain_pd + motor.drive_variables.target_postion); // 目标位置
