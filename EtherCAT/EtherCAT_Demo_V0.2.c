 ...
 * @LastEditTime: 2024-09-25 14:34:52
 * @Description:
 * @FilePath: /EtherCAT/EtherCAT_Demo_V0.2.c
 */
#include <stdio.h>
#include <stdlib.h>
#include <ecrt.h>
...
int main(int argc, char **argv)
{
    ...
    struct EL2889 el2889;
    EtherCAT_Master_Init(&Master);
    Init_EL2889(&Master, &el2889, EL2889_ALIAS, EL2889_INDEX, EL2889_VENDOR_ID, EL2889_PRODUCT_ID);
    EtherCAT_Master_Activate(&Master);
    Get_PD_EL2889(&el2889);
