...
/*
    ...
    sem_flag表示共享内存的读取方式，0表示互斥锁，1表示读写锁
...
// // template void SharedMemory::write<AllRotateMotorsCmdData>(AllRotateMotorsCmdData*, int, int);

// PYBIND11_MODULE(SharedMemory_py, m)
// {
//     m.doc() = "pybind sharedMemory plugin";
//     pybind11::class_<SharedMemory>(m, "SharedMemory")
//         .def(pybind11::init<const char*, int, i nt, int, std::string>())
//         .def("connect", [](pybind11::object& self){
//             auto& sm = reinterpret_cast<SharedMemory&>(self);
//             sm.connect();
//         })
//         .def("writeToRotateMotorSm", [](pybind11::object& self, AllRotateMotorsCmdData* rotateMotorCmd, int data_num, int offset){
//             auto& sm = reinterpret_cast<SharedMemory&>(self);
//             sm.write(rotateMotorCmd, data_num, offset);
//         })
//         .def("writeToLineMotorSm", [](pybind11::object& self, AllLineMotorsCmdData* lineMotorCmd, int data_num, int offset){
//             auto& sm = reinterpret_cast<SharedMemory&>(self);
//             sm.write(lineMotorCmd, data_num, offset);
//         })
//         .def("readFromRotateMotorSm", [](pybind11::object& self, AllRotateMotorsStateData* rotateMotorState, int data_num, int offset){
//             auto& sm = reinterpret_cast<SharedMemory&>(self);
//             sm.read(rotateMotorState, data_num, offset);
//         })
//         .def("readFromLineMotorSm", [](pybind11::object& self, AllLineMotorsStateData* lineMotorState, int data_num, int offset){
//             auto& sm = reinterpret_cast<SharedMemory&>(self);
//             sm.read(lineMotorState, data_num, offset);
//         })
//         ;
// }